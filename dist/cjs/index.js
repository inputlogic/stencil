...
var buildForm = function buildForm(_ref2) {
  ...
  var _stencil$config$react = stencil.config.reactHookForm,
    FormProvider = _stencil$config$react.FormProvider,
    useForm = _stencil$config$react.useForm;
  ...
  var Form = function Form(_ref4) {
    ...
    var _stencil$config$react2 = stencil.config.react.useState({}),
      _stencil$config$react3 = _slicedToArray(_stencil$config$react2, 2),
      metadata = _stencil$config$react3[0],
      setMetadata = _stencil$config$react3[1];
    ...
    return /*#__PURE__*/jsxRuntime.jsx(FormProvider, _objectSpread2(_objectSpread2({}, methods), {}, {
      metadata: metadata,
